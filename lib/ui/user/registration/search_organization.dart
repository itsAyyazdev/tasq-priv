...
class SearchOrganization extends StatelessWidget {
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: AutoCompleteSearch(
                        onSelected: (org) => sendTeamRequest(org, firstName, p),
                      )),
  ...
  void sendTeamRequest(Organization org, String name, AuthProvider p) {
    DocumentReference myDocRef = FBCollections.users.doc(p.userDataToSet.email);
    OrgMember member = OrgMember(
        orgId: org.orgId, user: myDocRef, status: Enums.orgRequest.pending);
    p.sendOrgJoinRequest(member: member);
    onNextTapped(name, p);
  }
